...
class UI_ThongKe(object):
        ...
        def filedimuon(self):
                ...
                df = pd.DataFrame(x)
                df.to_excel(os.path.join("FileExcel", "ThongKe", "Danhsach_SVDiMuon{}.xlsx".format(current_time)), engine='xlsxwriter', index=False)
        ...
        def filevang(self):
                ...
                df = pd.DataFrame(x)
                df.to_excel(os.path.join("FileExcel", "ThongKe", "Danhsach_SVVang{}.xlsx".format(current_time)), engine='xlsxwriter', index=False)
        ...
        def fileKDD(self):
                ...
                df = pd.DataFrame(x)
                df.to_excel(os.path.join("FileExcel", "ThongKe", "Danhsach_SVKhongDiemDanh{}.xlsx".format(current_time)), engine='xlsxwriter', index=False)
