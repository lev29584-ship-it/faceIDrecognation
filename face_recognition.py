...
class face_recognition(QThread):
    ...
    def run(self):
        ...
        recognizer.read(os.path.join(BASE_DIR, "TrainingImageLabel", "Trainner.yml"))
                ...
                for (x, y, w, h) in faces:
                    ...
                    if conf < 55:
                        ...
                        if conf < 45 and masv != self.masinhvien_save:
                            ...
                            self.link_image = os.path.join(BASE_DIR, "image", "diemdanh", f"{masv}_{current_time}.jpg")
